...
`;function a(e){let t={...e},n=[],r=()=>t,i=e=>{t={...t,...e},n.forEach(e=>e(t))},a=e=>(n.push(e),()=>{let t=n.indexOf(e);t>-1&&n.splice(t,1)});return{getState:r,setState:i,subscribe:a}}const o=`shopping_cart`,s=()=>{try{let e=localStorage.getItem(o);if(e){let t=JSON.parse(e);return Array.isArray(t)?{items:t}:t&&Array.isArray(t.items)?{items:t.items}:{items:[]}}}catch(e){console.error(`Failed to load cart state from localStorage:`,e)}return{items:[]}},c=e=>{try{localStorage.setItem(o,JSON.stringify(e))}catch(e){console.error(`Failed to save cart state to localStorage:`,e)}},l=a(s());l.subscribe(e=>{c(e)});const u=()=>{let e=l.getState().items,t=Array.isArray(e)?e.length:0;return`
  ...
  `,te=()=>f({children:i});function ne(e,t){return e.path===t}function re(e,t){if(!e.path.includes(`:`))return!1;let n=RegExp(`^`+e.path.replace(/:\w+/g,`[^/]+`)+`$`);return n.test(t)}function ie(e,t){let n=e.split(`/`).filter(e=>e.startsWith(`:`)).map(e=>e.slice(1)),r=t.split(`/`).slice(-n.length);return Object.fromEntries(n.map((e,t)=>[e,r[t]]))}function p(){return`/front_7th_chapter2-1/`}function m(e){let t=p();return t+e.replace(/^\//,``)}function ae(e={},t=!0){let n=new URLSearchParams(window.location.search);return Object.entries(e).forEach(([e,t])=>{t==null||t===``?n.delete(e):n.set(e,t)}),t&&n.set(`current`,`1`),n.toString()}function h(e={},t=!0){let n=ae(e,t);$.navigateTo(`/?${n}`)}function g(e){$.navigateTo(e)}function oe(e){let t=p(),n=()=>{let e=window.location.pathname;return t===`/`?e:e.replace(t,`/`)},r=t=>e.find(e=>ne(e,t))||e.find(e=>re(e,t)),i=(e,t)=>e.path.includes(`:`)?ie(e.path,t):{},a=()=>{let e=document.querySelector(`#root`);e&&(e.innerHTML=te())},o=async(e,t)=>{let n=document.querySelector(`#root`);if(!n)return;let r=e.element();await r.mount({params:t},n)},s=async()=>{let e=n(),t=r(e);if(!t){a();return}let s=i(t,e);await o(t,s)},c=()=>{window.addEventListener(`popstate`,s),s()},l=e=>{let t=m(e);window.history.pushState({},``,t),s()};return{initRouter:c,navigateTo:l}}const se=()=>`    <!-- 상품 목록으로 이동 -->
    ...
    <header class="bg-white shadow-sm sticky top-0 z-40">
  ...
  </header>`,ue=({image:e,title:t})=>`
        <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden mb-4">
            <img src=${e} alt=${t} class="w-full h-full object-cover product-detail-image">
        </div>`,de=`<svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                </svg>`,fe=`<svg class="w-4 h-4 text-gray-300" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                </svg>`,pe=({rating:e,reviewCount:t})=>{let n=5-e;return`       
            ...
            </div>`},_=({price:e})=>` <div class="mb-4">
              <span class="text-2xl font-bold text-blue-600">${e.toLocaleString()}원</span>
            </div>`,v=({stock:e})=>` <div class="text-sm text-gray-600 mb-4">
              재고 ${e}개
            </div>`,y=({description:e})=>` <div class="text-sm text-gray-700 leading-relaxed mb-6">
              ${e}
            </div>`,b=()=>`
            <div class="flex items-center">
            ...
            </div>`,me=({product:e})=>`<button id="add-to-cart-btn" 
      ...
      </div>`;async function x(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);return await c.json()}async function _e(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function ve(){let e=await fetch(`/api/categories`);return await e.json()}async function ye(e){let[t,n]=await Promise.all([x({limit:e.limit,search:e.search,category1:e.category1,category2:e.category2,current:e.current,sort:e.sort}),ve()]);return{products:t.products,pagination:t.pagination,categories:n}}async function be(e){let t=await _e(e.id);return{product:t}}function S({template:e,setup:t,mounted:n}){let r=(t={},n=!1,r=null)=>e({...t,loading:n,error:r}),i=async(e={},i)=>{if(!i)return;let a=r(e,!0,null);i.innerHTML=a;let o={},s=null;if(t)try{o=await t(e)}catch(e){s=e}let c=r({...e,...o},!1,s);i.innerHTML=c,n&&n()};return{render:r,mount:i}}function xe(e,t=`data-action`){return n=>{let r=n.target.closest(`[${t}]`);if(!r)return;let i=r.dataset.action;!i||!e[i]||e[i](n,r)}}function C(e,t,n=document,r=`data-action`){let i=xe(t,r);return n.addEventListener(e,i),()=>{n.removeEventListener(e,i)}}const w=`  <div class="bg-green-600 text-white px-4 py-3 rounded-lg shadow-lg flex items-center space-x-2 max-w-sm">
  ...
  </div>`;let T=null;function E(){let e=document.getElementById(`toast`);if(!e)return;T&&clearTimeout(T),e.innerHTML=`
    <div class="animate-slide-up">
      ${w}
    </div>
  `;let t=document.getElementById(`toast-close-btn`);t&&t.addEventListener(`click`,D),T=setTimeout(()=>{D()},3e3)}function D(){let e=document.getElementById(`toast`);if(!e)return;let t=e.firstElementChild;t&&(t.classList.remove(`animate-slide-up`),t.classList.add(`animate-slide-down`),setTimeout(()=>{e.innerHTML=``},300)),T&&(clearTimeout(T),T=null)}function O(e,t,n=1){let r=l.getState(),i=Array.isArray(r.items)?r.items:[],a=i.find(t=>t.productId===e);a?l.setState({items:i.map(t=>t.productId===e?{...t,quantity:t.quantity+n}:t)}):l.setState({items:[...i,{productId:e,quantity:n,title:t.title,image:t.image,lprice:t.lprice}]}),E()}function k(e){let t=l.getState().items;l.setState({items:t.map(t=>t.productId===e?{...t,quantity:t.quantity+1}:t)})}function A(e){let t=l.getState().items;l.setState({items:t.map(t=>t.productId===e?{...t,quantity:Math.max(1,t.quantity-1)}:t).filter(e=>e.quantity>0)})}function j(e){let t=l.getState().items;l.setState({items:t.filter(t=>t.productId!==e)})}function M(e){let t=l.getState().items;l.setState({items:t.filter(t=>!e.includes(t.productId))})}function Se(){l.setState({items:[]})}function N(e){g(`/product/${e}`)}function Ce(e){let t=e.closest(`.product-card`);if(!t)return;let n=t.dataset.productId;n&&N(n)}function we(e){let t=e.dataset.productId,n=e.dataset.productTitle,r=e.dataset.productImage,i=e.dataset.productLprice;!t||!n||!r||!i||O(t,{title:n,image:r,lprice:i},1)}function Te(e){let t=e.dataset.productId,n=e.dataset.productTitle,r=e.dataset.productImage,i=e.dataset.productLprice,a=document.querySelector(`#quantity-input`),o=a&&parseInt(a.value)||1;!t||!n||!r||!i||O(t,{title:n,image:r,lprice:i},o)}function Ee(){let e=document.querySelector(`#quantity-input`);if(!e)return;let t=Number(e.value);e.value=t+1}function De(){let e=document.querySelector(`#quantity-input`);if(!e)return;let t=Number(e.value);t>1&&(e.value=t-1)}function P(e,t,n={}){let r={[e]:t};e===`category1`&&(r.category2=null),h(r,n.resetPage!==!1)}function Oe(e){P(`search`,e)}function ke(e){P(`sort`,e)}function Ae(e){P(`limit`,e)}function F(e){P(`category1`,e)}function je(e){P(`category2`,e)}function Me(e){let t={};e===`reset`?(t.category1=null,t.category2=null):e===`category1`&&(t.category2=null),h(t)}let I=[];function Ne(){I.forEach(e=>e()),I=[];let e={"quantity-increase":()=>{Ee()},"quantity-decrease":()=>{De()},"add-to-cart-detail":(e,t)=>{Te(t)},"related-product":(e,t)=>{let n=t.dataset.productId;n&&N(n)},"navigate-category1":(e,t)=>{let n=t.dataset.category1;n&&F(n)},"navigate-category2":(e,t)=>{let n=t.dataset.category1,r=t.dataset.category2;n&&r&&h({category1:n,category2:r})}};I.push(C(`click`,e))}const L=({items:e=[]})=>{let t=e.reduce((e,t)=>e+parseInt(t.lprice)*t.quantity,0);return`  
      ...
      </div>`},Pe=({count:e})=>`    <div class="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
      ...
      </div>`,Fe=({item:e})=>{let{productId:t,title:n,image:r,lprice:i,quantity:a}=e,o=parseInt(i)*a;return` 
...
`,Le=({count:e})=>`     
        ...
        </div>`,Re=({items:e})=>e.map(e=>Fe({item:e})).join(``),ze=({items:e})=>`
      ...
      </div>`,R=({items:e=[]})=>e.length?ze({items:e}):Ie(),Be=({items:e=[]}={})=>`
      ...
      <div class="flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4">
        <div class="relative bg-white rounded-t-lg sm:rounded-lg shadow-xl w-full max-w-md sm:max-w-lg max-h-[90vh] overflow-hidden">
          ...
          <div class="flex flex-col max-h-[calc(90vh-120px)]" data-cart-modal-content>
            ${R({items:e})}
            ${e.length>0?L({items:e}):``}
          </div>
        </div>
      </div>
    </div>
  `;let z=null,B=[];function V(){B.forEach(e=>e()),B=[];let e=document.querySelector(`.cart-modal`);if(!e)return;let t={"cart-quantity-increase":(e,t)=>{let n=t.dataset.productId;n&&k(n)},"cart-quantity-decrease":(e,t)=>{let n=t.dataset.productId;n&&A(n)},"cart-item-remove":(e,t)=>{let n=t.dataset.productId;n&&j(n)},"cart-remove-selected":()=>{let e=document.querySelectorAll(`.cart-item-checkbox:checked`),t=Array.from(e).map(e=>e.dataset.productId);M(t)},"cart-clear":()=>{Se()},"cart-checkout":()=>{console.log(`구매하기 클릭`)},"cart-modal-close":()=>{H()}},n={"cart-select-all":(e,t)=>{let n=document.querySelectorAll(`.cart-item-checkbox`);n.forEach(e=>{e.checked=t.checked})},"cart-item-checkbox":()=>{let e=document.querySelectorAll(`.cart-item-checkbox`),t=document.querySelectorAll(`.cart-item-checkbox:checked`).length,n=document.getElementById(`cart-modal-select-all-checkbox`);n&&(n.checked=t===e.length&&e.length>0)}};B.push(C(`click`,t,e)),B.push(C(`change`,n,e));let r=e.querySelector(`.cart-modal-overlay`);if(r){let e=e=>{e.target===r&&H()};r.addEventListener(`click`,e),B.push(()=>r.removeEventListener(`click`,e))}let i=e=>{e.key===`Escape`&&H()};document.addEventListener(`keydown`,i),B.push(()=>document.removeEventListener(`keydown`,i))}function Ve(){let e=document.querySelector(`[data-cart-modal-content]`);if(!e)return;let{items:t}=l.getState();e.innerHTML=`
    ${R({items:t})}
    ${t.length>0?L({items:t}):``}
  `,V()}function He(){if(document.querySelector(`.cart-modal`))return;let e=document.getElementById(`root`);if(!e)return;let t=e.querySelector(`footer`),n=Be({items:l.getState().items});t&&t.parentElement?t.insertAdjacentHTML(`beforebegin`,n):e.insertAdjacentHTML(`beforeend`,n);let r=document.querySelector(`.cart-modal`);r&&r.offsetHeight,Ue()}function Ue(){V(),document.body.style.overflow=`hidden`,z&&z(),z=l.subscribe(()=>{Ve();let e=document.querySelector(`[data-cart-icon]`);e&&(e.innerHTML=u())})}function H(){z&&(z(),z=null),B.forEach(e=>e()),B=[];let e=document.querySelector(`.cart-modal`);e&&e.remove(),document.body.style.overflow=``}let U=null;function We(){U&&U(),U=l.subscribe(()=>{let e=document.querySelector(`[data-cart-icon]`);e&&(e.innerHTML=u())})}let W=[];function G(){W.forEach(e=>e()),W=[];let e={"cart-icon":()=>{He()},"navigate-home":e=>{e.preventDefault(),$.navigateTo(`/`)}};W.push(C(`click`,e,document)),We()}const Ge=({loading:e=!0,product:t=null})=>`
    <div class="min-h-screen bg-gray-50">
      ${le()}
...
`,Ke=async e=>await be(e.params||e),qe=()=>S({template:Ge,setup:Ke,mounted:()=>{Ne(),G()}}),Je=`          
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden animate-pulse">
  ...
  <div class="p-3">
    ...
    <div class="h-8 bg-gray-200 rounded"></div>
            ...
            </div>`,Ye=({error:e=null})=>{let t=e?.message||`Failed to fetch`;return`<div class="text-center py-12">
        ...
        </div>`,Ze=({loading:e,products:t=[],pagination:n={total:0,page:1,totalPages:1},error:r=null})=>{if(r)return`
      <div class="mb-6">
        ${Ye({error:r})}
      </div>
    ...
    </div>`},Qe=({search:e=``})=>` <div class="mb-4">
        <div class="relative">
    ...
    `).join(``)}
  `,it=({category2List:e=[],selectedCategory2:t=``})=>!e||e.length===0?``:`
    ...
    `}).join(``)}
  `,at=({loading:e,categories:t,limit:n,search:r=``,sort:i=`price_asc`,category1:a=``,category2:o=``})=>{let s=Object.keys(t),c=a?Object.keys(t[a]||{}):[];return`   
      <!-- 검색 및 필터 -->
          ...
          ${e?`    
            ...
            <div class="flex flex-wrap gap-2">
              ${tt()}
               ...
               <div class="flex flex-wrap gap-2">
                 ${it({category2List:c,selectedCategory2:o})}
               </div>`:`
               <!-- Category1 표시 (초기 상태) -->
               <div class="flex flex-wrap gap-2">
                 ${rt({category1:s})}
    ...
    `};let q=null,J=!1;function Y(){q&&(q.disconnect(),q=null),J=!1;let e=document.querySelector(`#infinite-scroll-sentinel`);e&&(q=new IntersectionObserver(async t=>{t.forEach(async t=>{if(t.isIntersecting&&!J){J=!0;let t=new URLSearchParams(window.location.search),n=parseInt(t.get(`current`))||1,r=n+1;q.disconnect(),q=null;let i=document.querySelector(`#products-grid`);if(i){let t=document.createElement(`div`);t.className=`text-center py-4 text-gray-600`,t.id=`infinite-scroll-loading`,t.textContent=`상품을 불러오는 중...`,i.parentElement.insertBefore(t,e)}try{let n=await x({limit:parseInt(t.get(`limit`))||20,search:t.get(`search`)||``,category1:t.get(`category1`)||``,category2:t.get(`category2`)||``,current:r,sort:t.get(`sort`)||`price_asc`});if(i&&n.products&&n.products.length>0){let e=n.products.map(e=>K({product:e})).join(``);i.insertAdjacentHTML(`beforeend`,e)}t.set(`current`,String(r));let a=`/?${t.toString()}`,o=m(a);window.history.pushState({},``,o);let s=document.getElementById(`infinite-scroll-loading`);s&&s.remove(),n.pagination&&n.pagination.page>=n.pagination.totalPages?e&&e.remove():Y()}catch(e){console.error(`Failed to load more products:`,e);let t=document.getElementById(`infinite-scroll-loading`);t&&(t.textContent=`상품을 불러오는데 실패했습니다.`),Y()}}})},{rootMargin:`20px`,threshold:.5}),q.observe(e))}let X=[];function ot(){X.forEach(e=>e()),X=[];let e={"filter-category1":(e,t)=>{let n=t.dataset.category1;n&&F(n)},"filter-category2":(e,t)=>{let n=t.dataset.category2;n&&je(n)},breadcrumb:(e,t)=>{let n=t.dataset.breadcrumb;n&&Me(n)},"product-click":(e,t)=>{Ce(t)},"add-to-cart":(e,t)=>{e.stopPropagation(),we(t)},"retry-products":()=>{let e=`/front_7th_chapter2-1/`,t=window.location.pathname;e!==`/`&&t.startsWith(e)&&(t=t.replace(e,`/`));let n=window.location.search;$.navigateTo(t+n)}},t={"filter-limit":(e,t)=>{let n=t.value;n&&Ae(n)},"filter-sort":(e,t)=>{let n=t.value;n&&ke(n)}},n={"filter-search":(e,t)=>{if(e.key===`Enter`){let e=t.value;Oe(e)}}};X.push(C(`click`,e)),X.push(C(`change`,t)),X.push(C(`keydown`,n)),Y()}const Z=()=>{let e=new URLSearchParams(window.location.search);return{limit:parseInt(e.get(`limit`))||20,search:e.get(`search`)||``,category1:e.get(`category1`)||``,category2:e.get(`category2`)||``,current:parseInt(e.get(`current`))||1,sort:e.get(`sort`)||`price_asc`}},Q=a(Z()),st=({loading:e=!0,limit:t=20,search:n=``,category1:r=``,category2:i=``,categories:a={},products:o=[],pagination:s={total:0},sort:c=`price_asc`,error:l=null})=>f({children:`${at({loading:e,categories:a,limit:t,search:n,sort:c,category1:r,category2:i})} ${Ze({loading:e,products:o,pagination:s,error:l})}`}),ct=async()=>{let e=Z();return Q.setState(e),await ye(e)},lt=()=>S({template:(e={})=>{let t=Q.getState();return st({...t,...e})},setup:ct,mounted:()=>{ot(),G()}}),$=oe([{path:`/`,element:lt},{path:`/product/:id`,element:qe}]),ut=()=>{$.initRouter()},dt=()=>r(async()=>{let{worker:e}=await import(`./browser-CcyfQrG1.js`);return{worker:e}},[]).then(({worker:e})=>{let t=`/front_7th_chapter2-1/`,n=`${t}mockServiceWorker.js`;return e.start({serviceWorker:{url:n},onUnhandledRequest:`bypass`})});async function ft(){ut()}dt().then(ft);