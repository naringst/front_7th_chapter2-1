...
`;function a(e){let t={...e},n=[],r=()=>t,i=e=>{t={...t,...e},n.forEach(e=>e(t))},a=e=>(n.push(e),()=>{let t=n.indexOf(e);t>-1&&n.splice(t,1)});return{getState:r,setState:i,subscribe:a}}const o=`shopping_cart`,s=()=>{try{let e=localStorage.getItem(o);if(e){let t=JSON.parse(e);return Array.isArray(t)?{items:t}:t&&Array.isArray(t.items)?{items:t.items}:{items:[]}}}catch(e){console.error(`Failed to load cart state from localStorage:`,e)}return{items:[]}},c=e=>{try{localStorage.setItem(o,JSON.stringify(e))}catch(e){console.error(`Failed to save cart state to localStorage:`,e)}},l=a(s());l.subscribe(e=>{c(e)});const u=()=>{let e=l.getState().items,t=Array.isArray(e)?e.length:0;return`
  ...
  `,te=()=>f({children:i});function ne(e,t){return e.path===t}function re(e,t){if(!e.path.includes(`:`))return!1;let n=RegExp(`^`+e.path.replace(/:\w+/g,`[^/]+`)+`$`);return n.test(t)}function ie(e,t){let n=e.split(`/`).filter(e=>e.startsWith(`:`)).map(e=>e.slice(1)),r=t.split(`/`).slice(-n.length);return Object.fromEntries(n.map((e,t)=>[e,r[t]]))}function p(){return`/front_7th_chapter2-1/`}function m(e){let t=p();return t+e.replace(/^\//,``)}function ae(e={},t=!0){let n=new URLSearchParams(window.location.search);return Object.entries(e).forEach(([e,t])=>{t==null||t===``?n.delete(e):n.set(e,t)}),t&&n.set(`current`,`1`),n.toString()}function h(e={},t=!0){let n=ae(e,t);$.navigateTo(`/?${n}`)}function oe(e){$.navigateTo(e)}function g(e){let t=p(),n=()=>{let e=window.location.pathname;if(t===`/`)return e===`/`?`/`:e.replace(/\/$/,``);if(e.startsWith(t)){let n=e.slice(t.length);return n.startsWith(`/`)||(n=`/${n}`),n!==`/`&&n.endsWith(`/`)&&(n=n.slice(0,-1)),n}return e===`/`?`/`:e.replace(/\/$/,``)},r=t=>e.find(e=>ne(e,t))||e.find(e=>re(e,t)),i=(e,t)=>e.path.includes(`:`)?ie(e.path,t):{},a=()=>{let e=document.querySelector(`#root`);e&&(e.innerHTML=te())},o=async(e,t)=>{let n=document.querySelector(`#root`);if(!n)return;let r=e.element();await r.mount({params:t},n)},s=async()=>{let e=n(),t=r(e);if(!t){a();return}let s=i(t,e);await o(t,s)},c=()=>{window.addEventListener(`popstate`,s),s()},l=e=>{let t=m(e);window.history.pushState({},``,t),s()};return{initRouter:c,navigateTo:l}}const _=()=>`    <!-- 상품 목록으로 이동 -->
      <div class="mb-6">
        <button class="block w-full text-center bg-gray-100 text-gray-700 py-3 px-4 rounded-md 
          hover:bg-gray-200 transition-colors go-to-product-list">
          상품 목록으로 돌아가기
        </button>
      </div>`,v=({category1:e,category2:t})=>`
       <nav class="mb-4">
  ...
  </header>`,ce=({image:e,title:t})=>`
        <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden mb-4">
            <img src=${e} alt=${t} class="w-full h-full object-cover product-detail-image">
        </div>`,le=`<svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                </svg>`,ue=`<svg class="w-4 h-4 text-gray-300" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                </svg>`,de=({rating:e,reviewCount:t})=>{let n=5-e;return`       
            ...
            </div>`},fe=({price:e})=>` <div class="mb-4">
              <span class="text-2xl font-bold text-blue-600">${e.toLocaleString()}원</span>
            </div>`,pe=({stock:e})=>` <div class="text-sm text-gray-600 mb-4">
              재고 ${e}개
            </div>`,me=({description:e})=>` <div class="text-sm text-gray-700 leading-relaxed mb-6">
              ${e}
            </div>`,he=()=>`
            <div class="flex items-center">
            ...
            </div>`,ge=({product:e})=>`<button id="add-to-cart-btn" 
  ...
  </div>`;let S=null;function C(){let e=document.getElementById(`toast`);if(!e)return;S&&clearTimeout(S),e.innerHTML=`
    <div class="animate-slide-up">
      ${we}
    </div>
  `;let t=document.getElementById(`toast-close-btn`);t&&t.addEventListener(`click`,w),S=setTimeout(()=>{w()},3e3)}function w(){let e=document.getElementById(`toast`);if(!e)return;let t=e.firstElementChild;t&&(t.classList.remove(`animate-slide-up`),t.classList.add(`animate-slide-down`),setTimeout(()=>{e.innerHTML=``},300)),S&&(clearTimeout(S),S=null)}function T(e,t,n=1){let r=l.getState(),i=Array.isArray(r.items)?r.items:[],a=i.find(t=>t.productId===e);a?l.setState({items:i.map(t=>t.productId===e?{...t,quantity:t.quantity+n}:t)}):l.setState({items:[...i,{productId:e,quantity:n,title:t.title,image:t.image,lprice:t.lprice}]}),C()}function E(e){let t=l.getState().items;l.setState({items:t.map(t=>t.productId===e?{...t,quantity:t.quantity+1}:t)})}function D(e){let t=l.getState().items;l.setState({items:t.map(t=>t.productId===e?{...t,quantity:Math.max(1,t.quantity-1)}:t).filter(e=>e.quantity>0)})}function O(e){let t=l.getState().items;l.setState({items:t.filter(t=>t.productId!==e)})}function k(e){let t=l.getState().items;l.setState({items:t.filter(t=>!e.includes(t.productId))})}function Te(){l.setState({items:[]})}function A(e){oe(`/product/${e}`)}function Ee(e){let t=e.closest(`.product-card`);if(!t)return;let n=t.dataset.productId;n&&A(n)}function De(e){let t=e.dataset.productId,n=e.dataset.productTitle,r=e.dataset.productImage,i=e.dataset.productLprice;!t||!n||!r||!i||T(t,{title:n,image:r,lprice:i},1)}function Oe(e){let t=e.dataset.productId,n=e.dataset.productTitle,r=e.dataset.productImage,i=e.dataset.productLprice,a=document.querySelector(`#quantity-input`),o=a&&parseInt(a.value)||1;!t||!n||!r||!i||T(t,{title:n,image:r,lprice:i},o)}function ke(){let e=document.querySelector(`#quantity-input`);if(!e)return;let t=Number(e.value);e.value=t+1}function Ae(){let e=document.querySelector(`#quantity-input`);if(!e)return;let t=Number(e.value);t>1&&(e.value=t-1)}function j(e,t,n={}){let r={[e]:t};e===`category1`&&(r.category2=null),h(r,n.resetPage!==!1)}function je(e){j(`search`,e)}function Me(e){j(`sort`,e)}function Ne(e){j(`limit`,e)}function M(e){j(`category1`,e)}function Pe(e){j(`category2`,e)}function Fe(e){let t={};e===`reset`?(t.category1=null,t.category2=null):e===`category1`&&(t.category2=null),h(t)}let N=[];function Ie(){N.forEach(e=>e()),N=[];let e={"quantity-increase":()=>{ke()},"quantity-decrease":()=>{Ae()},"add-to-cart-detail":(e,t)=>{Oe(t)},"related-product":(e,t)=>{let n=t.dataset.productId;n&&A(n)},"navigate-category1":(e,t)=>{let n=t.dataset.category1;n&&M(n)},"navigate-category2":(e,t)=>{let n=t.dataset.category1,r=t.dataset.category2;n&&r&&h({category1:n,category2:r})}};N.push(x(`click`,e))}const P=({items:e=[]})=>{let t=e.reduce((e,t)=>e+parseInt(t.lprice)*t.quantity,0);return`  
      ...
      </div>`},F=({count:e})=>`    <div class="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
      ...
      </div>`,Le=({item:e})=>{let{productId:t,title:n,image:r,lprice:i,quantity:a}=e,o=parseInt(i)*a;return` 
...
`,ze=({count:e})=>`     
        ...
        </div>`,I=({items:e})=>e.map(e=>Le({item:e})).join(``),Be=({items:e})=>`
      ...
      </div>`,L=({items:e=[]})=>e.length?Be({items:e}):Re(),Ve=({items:e=[]}={})=>`
      ...
      <div class="flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4">
        <div class="relative bg-white rounded-t-lg sm:rounded-lg shadow-xl w-full max-w-md sm:max-w-lg max-h-[90vh] overflow-hidden">
          ...
          <div class="flex flex-col max-h-[calc(90vh-120px)]" data-cart-modal-content>
            ${L({items:e})}
            ${e.length>0?P({items:e}):``}
          </div>
        </div>
      </div>
    </div>
  `;let R=null,z=[];function B(){z.forEach(e=>e()),z=[];let e=document.querySelector(`.cart-modal`);if(!e)return;let t={"cart-quantity-increase":(e,t)=>{let n=t.dataset.productId;n&&E(n)},"cart-quantity-decrease":(e,t)=>{let n=t.dataset.productId;n&&D(n)},"cart-item-remove":(e,t)=>{let n=t.dataset.productId;n&&O(n)},"cart-remove-selected":()=>{let e=document.querySelectorAll(`.cart-item-checkbox:checked`),t=Array.from(e).map(e=>e.dataset.productId);k(t);let n=document.getElementById(`cart-modal-remove-selected-btn`);n&&n.classList.add(`hidden`)},"cart-clear":()=>{Te()},"cart-checkout":()=>{console.log(`구매하기 클릭`)},"cart-modal-close":()=>{H()}},n={"cart-select-all":(e,t)=>{let n=document.querySelectorAll(`.cart-item-checkbox`);n.forEach(e=>{e.checked=t.checked}),V()},"cart-item-checkbox":()=>{let e=document.querySelectorAll(`.cart-item-checkbox`),t=document.querySelectorAll(`.cart-item-checkbox:checked`).length,n=document.getElementById(`cart-modal-select-all-checkbox`);n&&(n.checked=t===e.length&&e.length>0),V()}};z.push(x(`click`,t,e)),z.push(x(`change`,n,e));let r=e.querySelector(`.cart-modal-overlay`);if(r){let e=e=>{e.target===r&&H()};r.addEventListener(`click`,e),z.push(()=>r.removeEventListener(`click`,e))}let i=e=>{e.key===`Escape`&&H()};document.addEventListener(`keydown`,i),z.push(()=>document.removeEventListener(`keydown`,i))}function He(){let e=document.querySelector(`[data-cart-modal-header]`);if(!e)return;let{items:t}=l.getState();e.innerHTML=F({count:t.length})}function Ue(){let e=document.querySelector(`[data-cart-modal-content]`);if(!e)return;let{items:t}=l.getState();e.innerHTML=`
    ${L({items:t})}
    ${t.length>0?P({items:t}):``}
  `,B()}function We(){if(document.querySelector(`.cart-modal`))return;let e=document.getElementById(`root`);if(!e)return;let t=e.querySelector(`footer`),n=Ve({items:l.getState().items});t&&t.parentElement?t.insertAdjacentHTML(`beforebegin`,n):e.insertAdjacentHTML(`beforeend`,n);let r=document.querySelector(`.cart-modal`);r&&r.offsetHeight,Ge(),V()}function V(){let e=document.querySelectorAll(`.cart-item-checkbox:checked`).length,t=document.getElementById(`cart-modal-remove-selected-btn`);t&&(e>0?(t.classList.remove(`hidden`),t.textContent=`선택한 상품 삭제 (${e}개)`):t.classList.add(`hidden`))}function Ge(){B(),document.body.style.overflow=`hidden`,R&&R(),R=l.subscribe(()=>{He(),Ue();let e=document.querySelector(`[data-cart-icon]`);e&&(e.innerHTML=u()),V()})}function H(){R&&(R(),R=null),z.forEach(e=>e()),z=[];let e=document.querySelector(`.cart-modal`);e&&e.remove(),document.body.style.overflow=``}let U=null;function Ke(){U&&U(),U=l.subscribe(()=>{let e=document.querySelector(`[data-cart-icon]`);e&&(e.innerHTML=u())})}let W=[];function G(){W.forEach(e=>e()),W=[];let e={"cart-icon":()=>{We()},"navigate-home":e=>{e.preventDefault(),$.navigateTo(`/`)}};W.push(x(`click`,e,document)),Ke()}const qe=({loading:e=!0,product:t=null})=>`
    <div class="min-h-screen bg-gray-50">
      ${se()}
      ...
      `:`
        ${v({category1:t.category1,category2:t.category2})}
        ${_e({product:t})}
        ${_()}
        ${ve()}
      `}
...
`,Je=async e=>await Se(e.params||e),Ye=()=>b({template:qe,setup:Je,mounted:()=>{Ie(),G()}}),Xe=`          
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden animate-pulse">
  ...
  <div class="p-3">
    ...
    <div class="h-8 bg-gray-200 rounded"></div>
...
</div>`,K=({product:e})=>`<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden product-card"
                 data-product-id="${e.productId}">
              <!-- 상품 이미지 -->
            ...
            </div>`,Ze=({error:e=null})=>{let t=e?.message||`Failed to fetch`;return`<div class="text-center py-12">
        ...
        </div>`,$e=({loading:e,products:t=[],pagination:n={total:0,page:1,totalPages:1},error:r=null})=>{if(r)return`
      <div class="mb-6">
        ${Ze({error:r})}
      </div>
    ...
    </div>`},et=({search:e=``})=>` <div class="mb-4">
        <div class="relative">
    ...
    `).join(``)}
  `,ot=({category2List:e=[],selectedCategory2:t=``})=>!e||e.length===0?``:`
    ...
    `}).join(``)}
  `,st=({loading:e,categories:t,limit:n,search:r=``,sort:i=`price_asc`,category1:a=``,category2:o=``})=>{let s=Object.keys(t),c=a?Object.keys(t[a]||{}):[];return`   
      <!-- 검색 및 필터 -->
          ...
          ${e?`    
            ...
            <div class="flex flex-wrap gap-2">
              ${rt()}
               ...
               <div class="flex flex-wrap gap-2">
                 ${ot({category2List:c,selectedCategory2:o})}
               </div>`:`
               <!-- Category1 표시 (초기 상태) -->
               <div class="flex flex-wrap gap-2">
                 ${at({category1:s})}
    ...
    `};let q=null,J=!1;function Y(){q&&(q.disconnect(),q=null),J=!1;let e=document.querySelector(`#infinite-scroll-sentinel`);e&&(q=new IntersectionObserver(async t=>{t.forEach(async t=>{if(t.isIntersecting&&!J){J=!0;let t=new URLSearchParams(window.location.search),n=parseInt(t.get(`current`))||1,r=n+1;q.disconnect(),q=null;let i=document.querySelector(`#products-grid`);if(i){let t=document.createElement(`div`);t.className=`text-center py-4 text-gray-600`,t.id=`infinite-scroll-loading`,t.textContent=`상품을 불러오는 중...`,i.parentElement.insertBefore(t,e)}try{let n=await y({limit:parseInt(t.get(`limit`))||20,search:t.get(`search`)||``,category1:t.get(`category1`)||``,category2:t.get(`category2`)||``,current:r,sort:t.get(`sort`)||`price_asc`});if(i&&n.products&&n.products.length>0){let e=n.products.map(e=>K({product:e})).join(``);i.insertAdjacentHTML(`beforeend`,e)}t.set(`current`,String(r));let a=`/?${t.toString()}`,o=m(a);window.history.pushState({},``,o);let s=document.getElementById(`infinite-scroll-loading`);s&&s.remove(),n.pagination&&n.pagination.page>=n.pagination.totalPages?e&&e.remove():Y()}catch(e){console.error(`Failed to load more products:`,e);let t=document.getElementById(`infinite-scroll-loading`);t&&(t.textContent=`상품을 불러오는데 실패했습니다.`),Y()}}})},{rootMargin:`20px`,threshold:.5}),q.observe(e))}let X=[];function ct(){X.forEach(e=>e()),X=[];let e={"filter-category1":(e,t)=>{let n=t.dataset.category1;n&&M(n)},"filter-category2":(e,t)=>{let n=t.dataset.category2;n&&Pe(n)},breadcrumb:(e,t)=>{let n=t.dataset.breadcrumb;n&&Fe(n)},"product-click":(e,t)=>{Ee(t)},"add-to-cart":(e,t)=>{e.stopPropagation(),De(t)},"retry-products":()=>{let e=`/front_7th_chapter2-1/`,t=window.location.pathname;e!==`/`&&t.startsWith(e)&&(t=t.replace(e,`/`));let n=window.location.search;$.navigateTo(t+n)}},t={"filter-limit":(e,t)=>{let n=t.value;n&&Ne(n)},"filter-sort":(e,t)=>{let n=t.value;n&&Me(n)}},n={"filter-search":(e,t)=>{if(e.key===`Enter`){let e=t.value;je(e)}}};X.push(x(`click`,e)),X.push(x(`change`,t)),X.push(x(`keydown`,n)),Y()}const Z=()=>{let e=new URLSearchParams(window.location.search);return{limit:parseInt(e.get(`limit`))||20,search:e.get(`search`)||``,category1:e.get(`category1`)||``,category2:e.get(`category2`)||``,current:parseInt(e.get(`current`))||1,sort:e.get(`sort`)||`price_asc`}},Q=a(Z()),lt=({loading:e=!0,limit:t=20,search:n=``,category1:r=``,category2:i=``,categories:a={},products:o=[],pagination:s={total:0},sort:c=`price_asc`,error:l=null})=>f({children:`${st({loading:e,categories:a,limit:t,search:n,sort:c,category1:r,category2:i})} ${$e({loading:e,products:o,pagination:s,error:l})}`}),ut=async()=>{let e=Z();return Q.setState(e),await xe(e)},dt=()=>b({template:(e={})=>{let t=Q.getState();return lt({...t,...e})},setup:ut,mounted:()=>{ct(),G()}}),$=g([{path:`/`,element:dt},{path:`/product/:id`,element:Ye}]),ft=()=>{$.initRouter()},pt=()=>r(async()=>{let{worker:e}=await import(`./browser-CcyfQrG1.js`);return{worker:e}},[]).then(({worker:e})=>{let t=`/front_7th_chapter2-1/`,n=`${t}mockServiceWorker.js`;return e.start({serviceWorker:{url:n},onUnhandledRequest:`bypass`})});async function mt(){ft()}pt().then(mt);